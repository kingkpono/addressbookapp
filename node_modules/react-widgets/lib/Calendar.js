      ...
      if (direction) {
        if (ctrl) {
          ...
          if (!_dates2.default.eq(currentDate, nextDate, unit)) {
            ...
            if (_dates2.default.gt(nextDate, currentDate, view)) _this8.navigate(RIGHT, nextDate);else if (_dates2.default.lt(nextDate, currentDate, view)) _this8.navigate(LEFT, nextDate);else _this8.setCurrentDate(nextDate);
          }
        }
      }
