...
var Combobox = (0, _withRightToLeft2.default)(_class = (_class2 = (_temp = _class3 = function (_React$Component) {
  ...
  initializer: function initializer() {
    ...
    return function (e) {
      ...
      if (key === 'End' && isOpen) {
        e.preventDefault();
        _this4.setState({ focusedItem: list.last() });
      } else if (key === 'Home' && isOpen) {
        e.preventDefault();
        _this4.setState({ focusedItem: list.first() });
      ...
      function select(item, fromList) {
        if (!item) return self.change((0, _reactDom.findDOMNode)(self.refs.input).value, false);
